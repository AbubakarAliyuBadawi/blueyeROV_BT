...
def generate_launch_description():
    ...
    config_path = os.path.join(pkg_project_simulator_launch, 'config', 'generated_mundus_mir_simple_world', "robot.yaml")
    ...
    generate_sdf_node = Node(
        ...
        parameters=[{
            ...
            "launch_file": "generated_mundus_mir_simple_world",
        }]
    )
    ...
    launch_gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(pkg_project_bringup, 'launch', 'generated_mundus_mir_simple_world.launch.py')),
    )
