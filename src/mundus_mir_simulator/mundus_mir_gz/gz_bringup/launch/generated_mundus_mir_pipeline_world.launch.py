...
def generate_launch_description():
    ...
    bridge_config_path = os.path.join(pkg_project_simulator_launch, 'config', "generated_mundus_mir_pipeline_world", 'generated_bridge.yaml')
    ros_bridge = Node(
