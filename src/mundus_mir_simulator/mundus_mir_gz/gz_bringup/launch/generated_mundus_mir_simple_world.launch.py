...
def generate_launch_description():
    ...
    robot_config_path = os.path.join(pkg_project_simulator_launch, 'config', "generated_mundus_mir_simple_world", 'robot.yaml')
    ...
    bridge_config_path = os.path.join(pkg_project_simulator_launch, 'config', "generated_mundus_mir_simple_world", 'generated_bridge.yaml')
    ros_bridge = Node(
