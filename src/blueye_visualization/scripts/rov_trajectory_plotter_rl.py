...
class ROVTrajectoryPlotter(Node):
    def __init__(self):
        ...
        # Add mission state tracking - UPDATED for RL states without Transit_2
        self.mission_states = []
        self.mission_times = []
        self.state_names = {
            1: "UnDocking",
        ...
        self.axs[0].set_yticks(range(1, 7))  # UPDATED for 6 states
        ...
        self.axs[0].set_ylim(0.5, 6.5)  # UPDATED for 6 states
    ...
    def mission_state_callback(self, msg):
        with self.plot_lock:
            ...
            # Check if the state is valid (1-6)
            if 1 <= state_id <= 6:  # UPDATED for 6 states
