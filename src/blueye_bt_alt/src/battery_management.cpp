...
public:
    ReturnCalculator() : Node("return_calculator") {
        ...
        battery_sub_ = this->create_subscription<mundus_mir_msgs_alt::msg::BatteryStatusAlt>(
            "/blueye/battery",
            10,
        ...
        // Create publisher
        recommendation_pub_ = this->create_publisher<mundus_mir_msgs_alt::msg::ReturnRecommendationAlt>(
...
private:
    ...
    // Publisher
    rclcpp::Publisher<mundus_mir_msgs_alt::msg::ReturnRecommendationAlt>::SharedPtr recommendation_pub_;
    ...
    void calculateRecommendation() {
        auto msg = std::make_unique<mundus_mir_msgs_alt::msg::ReturnRecommendationAlt>();
        msg->stamp = this->now();
